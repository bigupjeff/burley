...
<p class="has-extra-small-font-size"><?php echo esc_html__( 'Copyright', 'burley' ) . ' ' . esc_html( date_i18n( _x( 'Y', 'copyright date format', 'burley' ) ) ); ?></p><!-- /wp:paragraph -->
